...
// This function below allows us to choose what parts of state we want from the redux store. In this component we will return all of state.
...
// We use the mapStateToProps function with connect to connect App.js with the redux store.
